...
import { DMenuDivider, DMenuDropdown, DMenuItem, DMenuLabel, DMenuTarget, type TDMenuType } from './resources'
...
const DMenu: TDMenuType = ({ children, classNames, ...rest }) => {
    /**
     ...
     * Spread remaining props from TDMenuType
     */
    return (
