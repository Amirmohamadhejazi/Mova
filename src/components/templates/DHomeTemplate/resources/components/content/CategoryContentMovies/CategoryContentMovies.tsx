    ...
    return (
        <div className='flex flex-col gap-y-10'>
            ...
            {/* <div className='flex flex-col gap-y-5 text-white'>
                <span className='font-bold text-lg md:text-xl '>محبوب ترین فیلم ها</span>
                ...
                <DFetchingContainer
                    ...
                    emptyBoundary={dataGeneral?.length === 0 && <EmptyBoundary />}
                >
                    {dataGeneral && dataGeneral[0] ? (
                        <div>
                            <DSwiperCarts>
                                <>
                                    {dataGeneral[0].data.map((items) => (
                                        <SwiperSlide key={items.id}>
                                            <div
                                                className='filter brightness-75 h-[250px] w-full bg-center	   text-white bg-cover  rounded'
                                                style={{ backgroundImage: `url('${items.banner}')` }}
            ...
            <div className='flex flex-col gap-y-5 text-white'>
                <span className='font-bold text-lg md:text-xl '>پر بازدید ترین سریال ها</span>
                ...
                <DFetchingContainer
                    ...
                    emptyBoundary={dataGeneral?.length === 0 && <EmptyBoundary />}
                >
                    {dataGeneral && dataGeneral[1] ? (
                        <div>
                            <DSwiperCarts>
                                <>
                                    {dataGeneral[1].data.map((items) => (
                                        <SwiperSlide key={items.id}>
                                            <div
                                                className='filter brightness-75 h-[250px] w-full bg-center	   text-white bg-cover  rounded'
                                                style={{ backgroundImage: `url('${items.banner}')` }}
            ...
            <div className='flex flex-col gap-y-5 text-white'>
                <span className='font-bold text-lg md:text-xl '>پر بازدید ترین انیمیشن ها</span>
                ...
                <DFetchingContainer
                    ...
                    emptyBoundary={dataGeneral?.length === 0 && <EmptyBoundary />}
                >
                    {dataGeneral && dataGeneral[2] ? (
                        <div>
                            <DSwiperCarts>
                                <>
                                    {dataGeneral[2].data.map((items) => (
                                        <SwiperSlide key={items.id}>
                                            <div
                                                className='filter brightness-75 h-[250px] w-full bg-center	   text-white bg-cover  rounded'
                                                style={{ backgroundImage: `url('${items.banner}')` }}
